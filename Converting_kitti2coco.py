...
# data_set path
kitti_img_path = 'E:/ObjectBox-master/dataset/KITTI/images/train/'
kitti_label_path = 'E:/ObjectBox-master/dataset/KITTI/labels/train/'

# transformed lables path
kitti_label_tosave_path = 'dataset/KITTI/labels2coco/'

# the real ptah of your data set
kitti_data_real_path = 'E:/ObjectBox-master/dataset/KITTI/images/train/'
...
# creating the train_set list
f = open('trainvalno5k-kitti.txt', 'w')
for img in kitti_images:
    f.write(kitti_data_real_path + img + '\n')
f.close()

# kitti dataset  Convert relative coordinates to absolute coordinates
